  ...
  <Teleport to="body">
    <Transition name="fade">
      <div v-if="modelValue" class="fixed inset-0 z-[100] flex items-center justify-center p-4" @click.self="close">
        ...
        <div
          class="relative bg-surface border border-border rounded-2xl shadow-modal w-full animate-scale-in"
        ...
        >
          <div v-if="$slots.header || title" class="flex items-start justify-between gap-4 p-5 pb-0">
            ...
            <button @click="close" class="p-1 -mr-1 text-text-tertiary hover:text-text-secondary rounded-lg hover:bg-surface-tertiary transition-colors">
