    ...
    public function index(): JsonResponse
    {
        ...
        $aggregateQuery = DB::table('invoices')
            ...
            ->select(DB::raw("
                ...
                SUM(CASE WHEN status IN ('sent', 'overdue') THEN balance_due_xof ELSE 0 END) as outstanding,
                SUM(CASE WHEN status IN ('paid', 'sent') THEN total_xof ELSE 0 END) as total_revenue
            "))
            ->first();
